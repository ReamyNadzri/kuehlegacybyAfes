...
<div id="id01" class="w3-modal" style="z-index: 9999;">
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px; position: relative;">
    <div class="w3-center w3-margin"><br>
      ...
      <h2>Grand Opening</h2>
      <p>This website is currently in still in testing. All features are fully functional and available at this time. We appreciate your understanding and welcome your feedback to improve the platform.</p>
