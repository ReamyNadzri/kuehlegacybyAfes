-- Insert Malaysian Kuih Recipes Only
-- Run this to add 10 traditional kuih recipes with ingredients and steps
USE kuehlegacy;

-- ========================================
-- KUEH RECIPES (Traditional Malaysian Kuih)
-- ========================================
...
1, 1, 1, 4, 'https://www.youtube.com/watch?v=example1', 'kuih_lapis.jpg', 'Haziq Akram');
...
3, 1, 1, 10, 'https://www.youtube.com/watch?v=example2', 'seri_muka.jpg', 'Haziq Akram');
...
1, 4, 1, 1, 'https://www.youtube.com/watch?v=example3', 'onde_onde.jpg', 'Haziq Akram');
...
2, 3, 1, 1, 'https://www.youtube.com/watch?v=example4', 'bahulu.jpg', 'Haziq Akram');
...
1, 3, 1, 3, 'https://www.youtube.com/watch?v=example5', 'ketayap.jpg', 'Haziq Akram');
...
2, 3, 2, 4, 'https://www.youtube.com/watch?v=example6', 'kapit.jpg', 'Haziq Akram');
...
3, 1, 1, 10, 'https://www.youtube.com/watch?v=example7', 'pulut_inti.jpg', 'Haziq Akram');
...
1, 1, 1, 8, 'https://www.youtube.com/watch?v=example8', 'talam.jpg', 'Haziq Akram');
...
1, 3, 2, 7, 'https://www.youtube.com/watch?v=example9', 'cara.jpg', 'Haziq Akram');
...
1, 3, 1, 2, 'https://www.youtube.com/watch?v=example10', 'bingka_ubi.jpg', 'Haziq Akram');

-- ========================================
-- ITEMS (Ingredients for each recipe)
-- ========================================
...
SELECT COUNT(*) as 'Total Recipes' FROM kueh;
SELECT COUNT(*) as 'Total Ingredients' FROM items;
SELECT COUNT(*) as 'Total Steps' FROM steps;
